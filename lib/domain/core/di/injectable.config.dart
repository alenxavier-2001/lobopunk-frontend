...
import 'package:lobopunk/application/account/account_bloc.dart' as _i11;
...
import 'package:lobopunk/domain/filepicker_service/file_picker_services.dart'
    as _i7;
import 'package:lobopunk/domain/user/user_services.dart' as _i9;
...
import 'package:lobopunk/infrastructure/file_picker_impl/file_picker_impl.dart'
    as _i8;
import 'package:lobopunk/infrastructure/userdetails/user_impl.dart' as _i10;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i7.FilePickerServices>(
      () => _i8.FilePickerImplementation());
  gh.lazySingleton<_i9.UserServices>(() => _i10.UserImplementation());
  gh.factory<_i11.AccountBloc>(() => _i11.AccountBloc(gh<_i9.UserServices>()));
  return get;
}
